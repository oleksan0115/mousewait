...
<div className="mid-main">
  <div className="container">
    ...
    <TabList>
      <Tab> <Link  to="/disneyland/mystore"> MW Store </Link> </Tab>
      <Tab> <Link  to="/disneyland/recharge"> Recharge Credits </Link> </Tab>
      <Tab> <Link  to="/disneyland/mycollection"> My Collection </Link> </Tab>
      <Tab> <Link  to="/disneyland/mytrade-request"> My Trade Request </Link> </Tab>
      <Tab> <Link  to="/disneyland/myhistory"> My  History </Link> </Tab>
    </TabList>
    ...
    <div className="MW-buy-sec">
        <div className="container">
          <div className="row">
            <div className="buy-m">
            <div className="mws-mid-sec mb-4"><h5 className="mid-head">My History</h5>
              </div>
              ...
              : myHistoryItem?.map((obj) =>obj.error != null?(  
              <div className="card-mn rounded">
              <div className="card-body">
              <h6 style={{fontWeight:'600'}}>{obj.error}</h6>
        </div></div>): (
...
<div className="buy-sec justify-content-between d-flex">
        <div className="buy-t"><h6>{obj.product_name}</h6>
        <span>Balance </span>
        <span style={{marginLeft:'1rem'}}>Debits  {obj.debits}</span>
        <span style={{marginLeft:'1rem'}}>Credits  {obj.credts}</span><br />
        <span ><i className="fa fa-calendar" aria-hidden="true" style={{marginRight:'8px'}}></i>{converDate(obj.createdon)}</span>
       </div> 
